...
namespace RollablePlus
{
    ...
    public sealed class ArenaGame : MonoBehaviour
    {
        ...
        public int Best => PlayerPrefs.GetInt("RollablePlus.Best", 0);
        [Header("Characters and pickups")]
        public RollableMotor player;
        ...
        void Awake()
        {
            ...
            int previousMute = PlayerPrefs.GetInt("RollablePlus.Muted", 0);
            MusicMuted = PlayerPrefs.GetInt("RollablePlus.MusicMuted", previousMute) == 1;
            SoundEffectsMuted = PlayerPrefs.GetInt("RollablePlus.SoundEffectsMuted", previousMute) == 1;
            Volume = Mathf.Clamp01(PlayerPrefs.GetFloat("RollablePlus.Volume", 1f));
            ReducedEffects = PlayerPrefs.GetInt("RollablePlus.ReducedEffects", 0) == 1;
        ...
        void End(GameState state)
        {
            ...
            {
                if (Score > Best) PlayerPrefs.SetInt("RollablePlus.Best", Score);
                PlayerPrefs.Save();
            }
            hud.ShowState();
        }
        ...
        public void ToggleMusic()
        {
            ...
            PlayerPrefs.SetInt("RollablePlus.MusicMuted", MusicMuted ? 1 : 0);
            PlayerPrefs.Save(); ApplySound(); hud.RefreshSettings();
        }
        public void ToggleSoundEffects()
        {
            SoundEffectsMuted = !SoundEffectsMuted;
            PlayerPrefs.SetInt("RollablePlus.SoundEffectsMuted", SoundEffectsMuted ? 1 : 0);
            PlayerPrefs.Save(); ApplySound(); hud.RefreshSettings();
        }
        public void SetVolume(float value)
        {
            Volume = Mathf.Clamp01(value);
            PlayerPrefs.SetFloat("RollablePlus.Volume", Volume);
            ApplySound();
        ...
        {
            ReducedEffects = !ReducedEffects; PlayerPrefs.SetInt("RollablePlus.ReducedEffects", ReducedEffects ? 1 : 0); PlayerPrefs.Save(); ApplyEffects(); hud.RefreshSettings();
        }
        void ApplyEffects()
        {
